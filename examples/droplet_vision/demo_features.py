...
if __name__ == '__main__':
    ...
    #
    #     dish_info, droplet_info, droplets_statistics, high_level_frame_stats, droplets_ids, grouped_stats = df.aggregate_droplet_info(dish_info_filename, droplet_info_filename, max_distance_tracking=100, min_sequence_length=20, join_min_frame_dist=1, join_max_frame_dist=10, min_droplet_radius=5)
    #
    #     df.generate_tracking_info_video(video_filename, droplet_info, droplets_statistics, grouped_stats, video_out=video_out)
    #
    #     break
    ...
    # for folder in folder_list:
    #     print folder
    #     config = create_default_features_config_from_folder(folder, debug=True)
    #
    ...
    #
    #     df.compute_droplet_features(dish_info_filename, droplet_info_filename, **config)
    #
    #     break
