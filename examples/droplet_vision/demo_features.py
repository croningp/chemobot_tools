...
if __name__ == '__main__':
    ...
    #
    #     dish_info, droplets_statistics, high_level_frame_stats, droplets_ids, grouped_stats = df.aggregate_droplet_info(dish_info_filename, droplet_info_filename, max_distance_tracking=40, min_sequence_length=20, join_min_frame_dist=1, join_max_frame_dist=10, min_droplet_radius=5)
    #
